...
ros::Publisher pubVoxelDownSampling;
...
pcl::PointCloud<PointT>::Ptr voxelGrid(pcl::PointCloud<PointT>::Ptr input) {
    ...
    pcl::toROSMsg(*cloud_filtered, voxel_downsampled);
    // pubVoxelDownSampling.publish(voxel_downsampled);
...
int main (int argc, char** argv) {
    ...
    pubVoxelDownSampling = nh.advertise<sensor_msgs::PointCloud2> ("voxel_downsampled", 1);
